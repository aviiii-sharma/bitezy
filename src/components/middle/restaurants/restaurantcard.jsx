    ...
    <div className='grid gap-10 grid-cols-4'>
      {restaurantdata.map((restaurant, id) => {
        ...
        return (
          ...
          <div key={id} className='card w-80 h-auto'>
            <div className='image flex justify-start items-end relative overflow-hidden rounded-xl'>
            <img
              className=' object-cover overflow-hidden relative w-full h-52'
            ...
            <div className="card-content pl-3 pt-3">
              ...
              <h2 className='text-sm'>{info.cuisines.join(", ")}</h2>
